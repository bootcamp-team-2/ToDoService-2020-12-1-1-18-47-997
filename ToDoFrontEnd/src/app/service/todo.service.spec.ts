...
describe('TodoService', () => {
  ...
  it('should delete todo item', () => {
    ...
    httpClientSpy.delete.and.returnValue(of(foundTodoItem));
  ...
  it('should process error response when delete 5 todoitems fail', fakeAsync(() => {
    // given
    const errorResponse = new HttpErrorResponse({
      error: 'test 404 error',
      status: 404, statusText: 'Not Found'
  ...
  it('should process error response when get 5 todoitems fail', fakeAsync(() => {
    // given
    const errorResponse = new HttpErrorResponse({
      error: 'test 404 error',
      status: 404, statusText: 'Not Found'
    ...
    tick(100);
    //then
    expect(service.getAllFailMessage).toBe("get specific because webapi error");
  }));
